...
c);g.sessionFail(a,f)})}},sessionFail:function(a,f){if(!a){var c=d(".aui-dialog:visible");if(c.length)a=c.find(".dialog-panel-body").empty(),c.find(".aui-button").attr("disabled","disabled");else throw Error("sessionFail method really expected a visible dialog about now :/");}f||(f=b.format("\u4f60\u7684\u4f1a\u8bdd\u5df2\u8fc7\u671f\u3002\u8bf7{0}\u91cd\u65b0\u52a0\u8f7d{1}\u6b64\u9875\u518d\u8bd5\u3002",'<a class="reload" href="">',"</a>"),a.on("click","a.reload",function(){g.location.reload()}));b.messages.warning(a,{body:f,closeable:!1,shadowed:!0})},Binder:{placeFocus:function(){var a,
...
b.setVisible(c,a);b.setVisible(this.getForm(),!a)},onUploadSuccess:function(){},getMessageHandler:function(){c||(c=b.MessageHandler({baseElement:e(".warning",f.baseElement)}));return c},getDefaultErrorMessage:function(){return "\u4e0d\u80fd\u4e0a\u4f20\u6587\u4ef6\u81f3 Confluence\u4e2d\uff0c\u670d\u52a1\u5668\u53ef\u80fd\u5df2\u5931\u6548\u3002"},getDefaultUploadingMessage:function(){return "\u6b63\u5728\u4e0a\u4f20\u6587\u4ef6\u2026"},getContentId:function(){return b.Meta.get("attachment-source-content-id")}},h&&h(f));g=a.getMessageHandler();d=a.getForm();b.Meta.getBoolean("can-attach-files")?
...
Confluence.Templates.Dialog.helpLink = function(opt_data, opt_ignored) {
  return '' + Confluence.Templates.Dialog.customHelpLink({href: opt_data.href, text: '' + soy.$$escapeHtml('\u5e2e\u52a9')});
};
if (goog.DEBUG) {
...
Confluence.Templates.ManageWatchers.dialogContent = function(opt_data, opt_ignored) {
  return '<div class="aui-group"><div class="aui-item page-watchers"><h3>' + soy.$$escapeHtml('\u5173\u6ce8\u672c\u9875\u9762') + '</h3><p>' + soy.$$escapeHtml('\u5f53\u9875\u9762\u53d1\u751f\u53d8\u5316\u65f6\u8fd9\u4e9b\u4eba\u4f1a\u88ab\u901a\u77e5\u3002') + '</p>' + Confluence.Templates.ManageWatchers.addWatcherForm({pageId: opt_data.pageId, xsrfToken: opt_data.xsrfToken, notificationType: 'page'}) + '<ul class="user-list"><li class="loading">' + soy.$$filterNoAutoescape('\u52a0\u8f7d\u2026') + '</li><li class="no-users hidden">' + soy.$$escapeHtml('\u65e0\u9875\u9762\u5173\u6ce8\u4eba') + '</li></ul></div><div class="aui-item space-watchers"><h3>' + soy.$$escapeHtml('\u5173\u6ce8\u672c\u9875\u9762') + '</h3><p>' + soy.$$escapeHtml('\u5f53\u7a7a\u95f4\u4e2d\u4efb\u4f55\u7684\u5185\u5bb9\u53d1\u751f\u53d8\u5316\u65f6\u8fd9\u4e9b\u4eba\u4f1a\u88ab\u901a\u77e5\u3002') + '</p>' + Confluence.Templates.ManageWatchers.addWatcherForm({pageId: opt_data.pageId, xsrfToken: opt_data.xsrfToken, notificationType: 'space'}) + '<ul class="user-list"><li class="loading">' + soy.$$filterNoAutoescape('\u52a0\u8f7d\u2026') + '</li><li class="no-users hidden">' + soy.$$escapeHtml('\u65e0\u7a7a\u95f4\u5173\u6ce8\u4eba') + '</li></ul></div></div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.ManageWatchers.addWatcherForm = function(opt_data, opt_ignored) {
  return '<form class="aui" action="' + soy.$$escapeHtml("/wiki") + '/json/addwatch.action" method="POST" id="manage-' + soy.$$escapeHtml(opt_data.notificationType) + '-watchers-form"><input type="hidden" name="atl_token" value="' + soy.$$escapeHtml(opt_data.xsrfToken) + '"><input type="hidden" name="pageId" value="' + soy.$$escapeHtml(opt_data.pageId) + '"/><input type="hidden" name="type" value="' + soy.$$escapeHtml(opt_data.notificationType) + '" /><input type="hidden" id="add-' + soy.$$escapeHtml(opt_data.notificationType) + '-watcher-username" name="username" value=""/><input id="add-' + soy.$$escapeHtml(opt_data.notificationType) + '-watcher-user" name="userFullName" class="text autocomplete-user" type="text" value="" placeholder="' + soy.$$escapeHtml('\u5168\u9762\u6216\u767b\u5f55\u540d') + '" data-max="10" data-target="#add-' + soy.$$escapeHtml(opt_data.notificationType) + '-watcher-username" data-dropdown-target="#add-' + soy.$$escapeHtml(opt_data.notificationType) + '-watcher-dropdown" data-template="{title}" data-none-message="' + soy.$$escapeHtml('\u65e0\u5339\u914d\u7528\u6237.') + '"><input type="submit" name="add"  class="button submit" value="' + soy.$$escapeHtml('\u6dfb\u52a0') + '"><div id="add-' + soy.$$escapeHtml(opt_data.notificationType) + '-watcher-dropdown" class="aui-dd-parent autocomplete"></div><div class="status hidden"></div></form>';
};
if (goog.DEBUG) {
...
define("confluence/page-children",["jquery","ajs","raphael","confluence/api/constants"],function(e,d,k,f){return function(c){var g,h,e=function(a){if(a.homePage){var b="\u4e3b\u9875";return'<span class="child-display"><span class="icon icon-home-page" title="'+b+'">'+b+':</span> <a href="'+f.CONTEXT_PATH+a.href+'">'+a.text+"</a></span>"}return'<span class="child-display"><span class="'+(a.recentlyUpdated?"icon icon-recently-updated-page":"icon icon-page")+'" title="Page">Page:</span> <a href="'+
...
e.toggleClass("selected ie-page-favourite-selected",!a);var b=!a?"\u79fb\u9664":"\u6536\u85cf",b=b+(" ("+"f"+")"),c=!a?d.format("{0}f{1}\u53d6\u6d88\u6536\u85cf","<u>","</u>"):d.format("{0}f{1}\u6536\u85cf","<u>","</u>");e.children("span").empty().append(f).append(" ").append(c);e.attr("title",b);f.toggleClass("aui-iconfont-unstar",a);f.toggleClass("aui-iconfont-star",!a);e.removeClass("waiting");
...
Confluence.Templates.Labels.nolabels = function(opt_data, opt_ignored) {
  return '<li class="no-labels-message">' + soy.$$escapeHtml('\u65e0\u6807\u7b7e') + '</li>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Labels.dialogLabels = function(opt_data, opt_ignored) {
  ...
  for (var labelIndex18 = 0; labelIndex18 < labelListLen18; labelIndex18++) {
    ...
    output += '<li class="aui-label ' + ((opt_data.editable) ? 'aui-label-closeable aui-label-split' : '') + '" data-label-id="' + soy.$$escapeHtml(labelData18.id) + '"><a class="aui-label-split-main" href="' + soy.$$escapeHtml("/wiki") + soy.$$escapeHtml(labelData18.link) + '" rel="tag">' + ((! labelData18.prefix || labelData18.prefix == 'global' || labelData18.prefix == 'team') ? soy.$$escapeHtml(labelData18.name) : soy.$$escapeHtml(labelData18.prefix) + ':' + soy.$$escapeHtml(labelData18.name)) + '</a>' + ((opt_data.editable) ? '<span class="aui-label-split-close"><span tabindex="0" class="aui-icon aui-icon-close"  title="' + soy.$$escapeHtml('\u5220\u9664\u6807\u7b7e') + '" original-title="' + soy.$$escapeHtml('\u5220\u9664\u6807\u7b7e') + '">' + soy.$$escapeHtml('\u5220\u9664\u6807\u7b7e') + '</span></span>' : '') + '</li>';
  }
  return output;
};
if (goog.DEBUG) {
...
Confluence.Quick.Create.discoveryTooltip = function(opt_data, opt_ignored) {
  return '<p class="title">' + soy.$$escapeHtml('\u8282\u7701\u65f6\u95f4\u7684\u6a21\u677f') + '</p><p>' + soy.$$filterNoAutoescape('\u60f3\u8981\u5feb\u901f\u521b\u5efa\u4e00\u9897\u8d5b\u8247\u7684\u9875\u9762\uff1f\u8fd9\u91cc\u6709\u4e00\u4e9b\u53ef\u4ee5\u5e2e\u5230\u4f60\u7684\u6a21\u677f\uff0c\u8001\u53f8\u673a\u5e26\u4f60\u8f7b\u677e\u4e0a\u8def~') + '</p><p><button class="aui-button" id="closeDisDialog">' + soy.$$escapeHtml('\u597d\u7684\uff0c\u77e5\u9053\u4e86') + '</button></p>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Blueprints.CreateSpace.createSpaceFormFields = function(opt_data, opt_ignored) {
  var output = '<fieldset><div class="field-group"><label for="name">' + soy.$$escapeHtml('\u7a7a\u95f4\u540d') + ((! opt_data.disableRequiredIcon) ? '<span class="aui-icon icon-required"/>' : '') + '</label><input class="text long-field" name="name" autocomplete="off" ' + ((opt_data.name) ? 'value="' + soy.$$escapeHtml(opt_data.name) + '"' : '') + '/>';
...
Confluence.Templates.Blueprints.CreateSpace.spaceFormPermissions = function(opt_data, opt_ignored) {
  return '<fieldset class="group" ><span class="aui-icon aui-icon-small ' + ((opt_data.spacePermission == 'private') ? 'aui-iconfont-locked' : 'aui-iconfont-unlocked') + '" id="permissions-group"></span><div class="checkbox"><input class="checkbox" type="checkbox" id="permission-private" name="spacePermission" value="private"' + ((opt_data.spacePermission == 'private') ? ' checked="checked"' : '') + ' /><label for="permission-private">' + soy.$$escapeHtml('\u53ea\u5bf9\u6211\u53ef\u89c1') + '</label></div></fieldset>';
};
if (goog.DEBUG) {
...
Confluence.Templates.Blueprints.CreateSpace.welcome = function(opt_data, opt_ignored) {
  return '<ul class="space-types"><li><p>' + soy.$$escapeHtml('\u56e2\u961f') + '</p></li><li><p>' + soy.$$escapeHtml('\u9879\u76ee') + '</p></li><li><p>' + soy.$$escapeHtml('\u90e8\u95e8') + '</p></li></ul><div class="space-description"><h1>' + soy.$$escapeHtml('\u9996\u9875\u662f\u4f60\u6240\u6709\u5185\u5bb9\u7684\u5bb6') + '</h1><ul><li>' + soy.$$escapeHtml('\u53ea\u8981\u4f60\u559c\u6b22\uff0c\u53ef\u4ee5\u4e3a\u4f01\u4e1a\u5185\u7684\u56e2\u961f\u3001\u9879\u76ee\u548c\u90e8\u95e8\u521b\u5efa\u4efb\u610f\u6570\u91cf\u7684\u7a7a\u95f4\u3002') + '</p></li><li>' + soy.$$escapeHtml('\u901a\u8fc7\u9875\u9762\u589e\u52a0\u6587\u6863\u3001\u6587\u4ef6\u3001\u7167\u7247\u5230\u4f60\u7684\u7a7a\u95f4\uff0c\u5e76\u4f7f\u5b83\u4eec\u6309\u5c42\u7ea7\u7ec4\u7ec7\u3002') + '</p></li><li>' + soy.$$escapeHtml('\u5728\u7a7a\u95f4\u4e2d\u4f7f\u7528\u535a\u5ba2\u6765\u5206\u4eab\u65b0\u95fb\u6216\u53d1\u5e03\u516c\u544a\u3002') + '</p></li></ul></div>';
};
if (goog.DEBUG) {
...
-1,u=function(c){for(var b=a("span").addClass("item-action"),d=0;d<c.keys.length;d++){d>0&&b.append(l("\u6216"));for(var e=c.keys[d],m=0;m<e.length;m++){m>0&&b.append(l("\u7136\u540e"));for(var q=b,j=e[m].split("+"),i=0;i<j.length;i++){i>0&&q.append(l("+"));for(var g=q,f=j[i].split(".."),h=0;h<f.length;h++){h>0&&g.append(l("\u5f80"));g.append(t(f[h]))}}}}return b},t=function(c){var b=a("kbd");switch(c){case "Shift":case "Sh":b.text("Shift");
...
define("confluence-keyboard-shortcuts/shortcut-dialog-tab-autoformat",["ajs","confluence/templates","jquery","confluence-keyboard-shortcuts/confluence-keyboard-shortcuts"],function(a,d,g,c){return function(){void 0===c.keyboardShortcuts.Autoformat&&(c.keyboardShortcuts.Autoformat=[]);var b=d.KeyboardShortcutsDialog.Autoformat,j=[{context:"autoformat.font_formatting",description:b.boldDescription(),action:"*\u7c97\u4f53*"},{context:"autoformat.font_formatting",
description:b.underlineDescription(),action:"+\u4e0b\u5212\u7ebf+"},{context:"autoformat.font_formatting",description:b.italicDescription(),action:"_\u659c\u4f53_"},{context:"autoformat.font_formatting",description:b.monospaceDescription(),action:"{{\u7edf\u4e00\u5b57\u8ddd}}"},{context:"autoformat.tables",description:b.tableDescription(),action:"||||| + \u56de\u8f66"},
{context:"autoformat.tables",description:b.tableWithHeadingsDiscriptions(),action:"||\u8868\u5934||\u8868\u5934||"},{context:"autoformat.styles",description:b.h1Description(),action:"h1. \u6807\u9898"},{context:"autoformat.styles",description:b.h3Description(),action:"h3. \u6807\u9898"},{context:"autoformat.styles",description:b.bqDescription(),action:"bq. \u5f15\u7528"},
{context:"autoformat.emoticons",img:"check.png",action:"(/)"},{context:"autoformat.emoticons",img:"smile.png",action:":)"},{context:"autoformat.lists",description:b.numberedListDescription(),action:"# \u6709\u5e8f\u5217\u8868"},{context:"autoformat.lists",description:b.bulletedListDescription(),
action:"* \u65e0\u5e8f\u5217\u8868"},{context:"autoformat.lists",description:b.inlineTaskListDescription(),action:"[] \u4efb\u52a1"},{context:"autoformat.autocomplete",description:"\u56fe\u7247/\u5a92\u4f53",action:"!"},{context:"autoformat.autocomplete",description:"\u94fe\u63a5",action:"["},
{context:"autoformat.autocomplete",description:"\u5b8f",action:"{"}],h=function(a,b,f){var a=g(d.KeyboardShortcutsDialog.keyboardShortcutModule({title:a})),k=a.find("ul"),c;c=g.grep(j,function(a){return a.context===b});for(var i=0,h=c.length;i<h;i++)k.append(f(c[i]));return a},f=function(a,b,d){return h(a,b,function(a){return d({output:a.description,type:a.action})})},l=function(d,e){var c=
a.params.staticResourceUrlPrefix+"/images/icons/emoticons/";return h(d,e,function(a){return b.emoticonHelpItem({src:c+a.img,type:a.action})})};return function(){var c=g(d.KeyboardShortcutsDialog.keyboardShortcutPanel({panelId:"autoformat-shortcuts-panel"})),e=c.children(".shortcutsmenu");e.append(f("\u5b57\u4f53\u683c\u5f0f\u5316","autoformat.font_formatting",b.simpleHelpItem));e.append(f("\u81ea\u52a8\u5b8c\u6210","autoformat.autocomplete",
b.keyboardShortcutItem));e.append(f("\u8868\u683c","autoformat.tables",b.tableHelpItem));e.append(f("\u6837\u5f0f","autoformat.styles",b.styleHelpItem).addClass("styles-module"));e.append(l("\u8868\u60c5","autoformat.emoticons"));e.append(f("\u5217\u8868","autoformat.lists",b.simpleHelpItem));a.Meta.get("remote-user")&&
c.find(".keyboard-shortcut-dialog-panel-header").append(b.configureAutocomplete({href:a.contextPath()+"/users/viewmyeditorsettings.action"}));return c}}});require("confluence/module-exporter").safeRequire("confluence-keyboard-shortcuts/shortcut-dialog-tab-autoformat",function(a){var d=require("ajs");d.toInit(function(){var g=a();d.bind("keyboard-shortcut-dialog-ready",function(a,b){b.addPanel("\u7f16\u8f91\u5668\u81ea\u52a8\u683c\u5f0f\u5316",g())})})});
}catch(e){WRMCB(e)};
;
try {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.configureAutocomplete = function(opt_data, opt_ignored) {
  return '<div id="keyboard-shortcut-autocomplete-message">' + soy.$$escapeHtml('\u914d\u7f6e\u81ea\u52a8\u5b8c\u6210,') + ' <a target="_blank" href=' + soy.$$escapeHtml(opt_data.href) + '>' + soy.$$escapeHtml('\u8f6c\u5230\u7f16\u8f91\u5668\u8bbe\u7f6e') + '</a></div>';
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.boldDescription = function(opt_data, opt_ignored) {
  return '<b>' + soy.$$escapeHtml('\u7c97\u4f53') + '</b> ' + soy.$$escapeHtml('\u6587\u672c');
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.underlineDescription = function(opt_data, opt_ignored) {
  return '<span style="text-decoration: underline;">' + soy.$$escapeHtml('\u4e0b\u5212\u7ebf') + '</span> ' + soy.$$escapeHtml('\u6587\u672c');
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.italicDescription = function(opt_data, opt_ignored) {
  return '<em>' + soy.$$escapeHtml('\u659c\u4f53') + '</em> ' + soy.$$escapeHtml('\u6587\u672c');
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.monospaceDescription = function(opt_data, opt_ignored) {
  return '<code>' + soy.$$escapeHtml('\u7edf\u4e00\u5b57\u8ddd') + '</code> ' + soy.$$escapeHtml('\u6587\u672c');
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.tableDescription = function(opt_data, opt_ignored) {
  return '<table class="confluenceTable"><tbody><tr><td class="confluenceTd">' + soy.$$escapeHtml('\u9996\u4e2a\u5355\u5143\u683c') + '</td><td class="confluenceTd">&nbsp;</td><td class="confluenceTd">&nbsp;</td><td class="confluenceTd">&nbsp;</td></tr></tbody></table>';
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.tableWithHeadingsDiscriptions = function(opt_data, opt_ignored) {
  return '<table class="confluenceTable"><tbody><tr><th class="confluenceTh">' + soy.$$escapeHtml('\u6807\u9898') + '</th><th class="confluenceTh">' + soy.$$escapeHtml('\u6807\u9898') + '</th></tr><tr><td class="confluenceTd">&#8203;</td><td class="confluenceTd">&#8203;</td></tr></tbody></table>';
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.h1Description = function(opt_data, opt_ignored) {
  return '<h1>' + soy.$$escapeHtml('\u6807\u9898') + '</h1>';
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.h3Description = function(opt_data, opt_ignored) {
  return '<h3>' + soy.$$escapeHtml('\u6807\u9898') + '</h3>';
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.bqDescription = function(opt_data, opt_ignored) {
  return '<blockquote>' + soy.$$escapeHtml('\u5f15\u7528') + '</blockquote>';
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.numberedListDescription = function(opt_data, opt_ignored) {
  return '<ol><li>' + soy.$$escapeHtml('\u6709\u5e8f\u5217\u8868') + '</li></ol>';
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.Autoformat.bulletedListDescription = function(opt_data, opt_ignored) {
  return '<ul><li>' + soy.$$escapeHtml('\u65e0\u5e8f\u5217\u8868') + '</li></ul>';
};
if (goog.DEBUG) {
...
Confluence.Templates.KeyboardShortcutsDialog.keyboardShortcutEnabledCheckbox = function(opt_data, opt_ignored) {
  return '<form name="shortcut-settings" id="shortcut-settings-form"><input type="checkbox" name="enabled" id="keyboard-shortcut-enabled-checkbox"><label for="keyboard-shortcut-enabled-checkbox">' + soy.$$escapeHtml('\u542f\u7528\u901a\u7528\u5feb\u6377\u952e') + '</label></form>';
};
if (goog.DEBUG) {
...
aui.labels.closeIconText = function(opt_data, opt_ignored) {
  return '' + ((opt_data.closeIconText) ? soy.$$escapeHtml(opt_data.closeIconText) : '(' + soy.$$escapeHtml('\u79fb\u9664') + ' ' + soy.$$escapeHtml(opt_data.text) + ')');
};
if (goog.DEBUG) {
...
"\u8f93\u5165\u503c"))}else d.append(g);f.styleClass&&d.addClass(f.styleClass);d.appendTo(a.$el)});this.$el.append(e).append(d).addClass(this.classNames.ROW+" "+this.classNames.READ_ONLY);this.trigger(this._event.RENDER,this.$el,c);this.$el.trigger(this._event.CONTENT_REFRESHED,[this.$el]);return this}});return h=h["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
...
"\u6b63\u88c5\u8f7d"}}});g.ClassNames=r.default;g.CustomCreateView=k.default;g.CustomEditView=h.default;g.CustomReadView=j.default;g.DataKeys=s.default;g.EditRow=t.default;g.EntryModel=p.default;g.Events=u.default;g.Row=q.default;g.Throbber=v.default;(0,w.default)("RestfulTable",g);m.default=g;return m=m["default"]}.call(this);
}catch(e){WRMCB(e)};
;
try {
